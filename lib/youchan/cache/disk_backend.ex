defmodule Youchan.Cache.DiskBackend do
  @moduledoc """
  ...
  * `:table_name` - The name of the DETS table to use (defaults to `:youchan_disk_cache`)
  * `:cache_dir` - Directory to store the cache files (defaults to "priv/youchan_cache")
  * `:max_size` - Maximum number of entries in the cache (defaults to 10,000)
  """

  @behaviour Youchan.Cache.Backend

  @default_cache_dir "priv/youchan_cache"
  ...
  @options_schema [
    ...
    max_size: [
      type: {:custom, Youchan.Cache.MemoryBackend, :validate_positive_integer, []},
